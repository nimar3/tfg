...
En este proyecto se ha utilizado \textit{unittest}, funcionalidad incluida en \textit{python3} para la creación de test unitarios. Los tests se encuentran en el fichero \textbf{tests.py} y a continuación podemos ver un extracto de su definición: \newline
