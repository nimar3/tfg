...
{
	name=Tarea,description={Trabajo a resolver asignado a un estudiante o equipo}
}
...
\begin{enumerate}
	...
	\item Subida de \Gls{contenedor}es de Nginx y Pizarra al Registro de \acrshort{gce}
	...
	\item Creación del \acrshort{nfs}
...
Una vez completado todos los pasos, se puede obtener la IP pública de Pizarra ejecutando el siguiente comando.
