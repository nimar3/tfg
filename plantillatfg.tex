...
Aquesta és una tasca complexa, d'una banda portar el procés d'enviament de codi a un entorn web i la interacció que tindrà amb el clúster \kahan del DSIC. I per l'altre, transformar les activitats de laboratori de les assignatures CPA i LPP amb noves mecàniques que fomentin a l'estudiant buscar millorar els seus resultats inclusivament després d'arribar a una resolució correcta als exercicis plantejats. \par
