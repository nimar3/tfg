...
explicación de la case job y automata aqui
...
En el ejemplo previo podemos ver la creación de dos \gls{insignia}s que se asignarán a un \gls{alumno} cuando la ejecución de su programa sea en menos de 10 segundos y también otro caso donde la posición de la ejecución quede entre las tres mejores. La descripción de los atributos es:
