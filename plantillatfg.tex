...
\begin{itemize}
	...
	\item Clonar el repositorio de Pizarra
	\begin{enumerate}
		...
		\end{lstlisting}
		\item Hacemos \foreignlanguage{english}{checkout} a la rama de desarrollo
		\begin{lstlisting}[language=bash]
		$ git checkout master
		...
		\end{lstlisting}
	\end{enumerate}
	\item Crear un entorno virtual e instalar todos los \Gls{paquete}s de Python necesarios
	\begin{lstlisting}[language=bash]
	$ python3 -m venv env
